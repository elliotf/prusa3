...
module x_end_motor_base(){
 ...
 translate(v=[-9.5,38,9.5]) cube(size = [8,30,19], center = true);
}
...
module x_end_motor_holes(){
  ...
  */
  ...
  translate(v=[-10,-15.5,-15.5]) 3mm_nut_hole();
  translate(v=[-10,-15.5,15.5]) 3mm_nut_hole();
  translate(v=[-10,15.5,-15.5]) 3mm_nut_hole();
  ...
  //translate([-10,-2.35,0]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 40, r=22.5*da6, $fn=6, center=true);
  ...
  // lower arm only
  //translate([-14,12,15.5]) cube([18,44,53], center = true);
  // thinner lower arm
  //translate([-20,12,-10]) cube([10,44,53], center = true);
  */
 }
}
